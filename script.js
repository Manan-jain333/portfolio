// const hamburger = document.querySelector('.hamburger-menu'); // Add a hamburger button in your HTML
// const navLinksContainer = document.querySelector('.nav-links');

// hamburger.addEventListener('click', () => {
//     navLinksContainer.classList.toggle('show'); // Ensure "show" is defined in your CSS to toggle visibility
// });
...
// Updated navigation menu functionality
const navLinksContainer = document.querySelector(".nav-links");
